...
const pages = {
  ...
  'konsaltynh.html': {
    title: 'Організація поліграфологічної служби під ключ | Червона лінія',
    description: 'Консалтинг та організація внутрішньої поліграфологічної служби під ключ: процеси, обладнання, навчання та стандарти перевірки персоналу.',
    keywords: 'поліграфологічна служба, консалтинг поліграф, поліграф для компанії, організація перевірок, перевірка персоналу',
  },
  ...
  'perevirka_ec.html': {
    title: 'Перевірка на поліграфі в будь-якій країні світу | Червона лінія',
    description: 'Перевірка на поліграфі з виїздом у будь-яку країну світу для приватних клієнтів, бізнесу та організацій. Узгоджуємо країну, місто й формат дослідження.',
    keywords: 'перевірка на поліграфі за кордоном, поліграф у будь-якій країні світу, виїзд поліграфолога за кордон, міжнародна перевірка на поліграфі',
  },
